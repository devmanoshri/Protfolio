  ...
  return (
    <motion.div
      ...
      <motion.a
        ...
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 1.1}} href="" className={`w-max flex items-center justify-center gap-2 border-[0.5px] rounded-full py-3 px-10 mx-auto my-20  duration-500 ${isDarkMode ? 'border-white text-white/80 hover:bg-(--dark-hover)' : 'border-gray-700 text-gray-700 hover:bg-(--light-hover)'}`}>
